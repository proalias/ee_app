...
{
	_id = 5; // for boost signal
}

void PassiveScene5::setup( FontRenderer &thefont, IconFactory &theIconFactory, ForegroundParticles &thefgParticles )
{
	font = &thefont;
	font->clear();
	...
	mCue = timeline().add( bind(&PassiveScene5::showFrame2, this), timeline().getCurrentTime() );
}


void PassiveScene5::showFrame2(){
	...
	mCue = timeline().add( bind(&PassiveScene5::showFrame3, this), timeline().getCurrentTime() + 10 );

}

void PassiveScene5::showFrame3(){
	...
	//_signal( this );
	font->animateOut();
	mCue = timeline().add( bind(&PassiveScene5::showFrame4, this), timeline().getCurrentTime() + 10 );

}

void PassiveScene5::showFrame4(){
